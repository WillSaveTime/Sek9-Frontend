...
functions.add('breakpoint-next', function(
...
functions.add('breakpoint-min', function(
  { value: breakpointName },
  breakpoints
) {
  const breakpointsMap = getBreakpoints(this.context, breakpoints)
...
functions.add('breakpoint-max', function(
  { value: breakpointName },
  breakpoints
) {
  const breakpointsMap = getBreakpoints(this.context, breakpoints)
...
functions.add('breakpoint-infix', function(
  { value: breakpointName },
  breakpoints
) {
  const breakpointsMap = getBreakpoints(this.context, breakpoints)
